  ...
  return (
    <div className="grid grid-cols-5 gap-x-24 gap-y-32 text-lg items-center">
      <div className="col-span-3">
        <h1 className="text-4xl mb-10 text-[#7C99B6] font-medium">
      ...
      <div className="col-span-3">
        ...
        <div className="space-y-8">
          ...
          <div>
            <a
              href="/cabins"
              className="inline-block mt-4 bg-[#C69963] px-8 py-5 text-[#2C3D4F] text-lg font-semibold hover:bg-[#B78343] transition-all"
            >
